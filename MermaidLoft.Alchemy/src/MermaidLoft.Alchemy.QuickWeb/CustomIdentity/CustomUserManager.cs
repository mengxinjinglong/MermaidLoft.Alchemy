...
namespace MermaidLoft.Alchemy.QuickWeb.CustomIdentity
{
    ...
    {
        public CustomUserManager() : base(new CustomUserSore<CustomUser>())
        {
        ...
        public override System.Threading.Tasks.Task<CustomUser> FindAsync(string userName, string password)
        {
            Task<CustomUser> taskInvoke = Task<CustomUser>.Factory.StartNew(() =>
            {
    ...
    /// </summary> 
    public class OldSystemPasswordHasher : Microsoft.AspNetCore.Identity.PasswordHasher
    {
